...
def serve_page_or_static(filepath):
    ...
    if filepath.endswith('.html'):
        ...
        protected_folders = ['home/', 'caliprofile/', 'cali-report/', 'cali-reports-data/', 'schedule-work/', 'caliprofile-pages/', 'tutorial/', 'cali-unit-convert/', 'cali-mv-chart/', 'cali-rtd-chart/']
